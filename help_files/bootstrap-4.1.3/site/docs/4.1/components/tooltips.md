...
<table class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>number | string</td>
      <td>0</td>
      <td>Offset of the tooltip relative to its target. For more information refer to Popper.js's <a href="https://popper-1.14.4.js.org/popper-documentation.html#modifiers..offset.offset">offset docs</a>.</td>
    </tr>
    <tr>
