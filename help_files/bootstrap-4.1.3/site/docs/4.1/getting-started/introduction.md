...
- Dropdowns for displaying and positioning (also requires [Popper.js](https://popper-1.14.4.js.org/))
- Modals for displaying, positioning, and scroll behavior
- Navbar for extending our Collapse plugin to implement responsive behavior
- Tooltips and popovers for displaying and positioning (also requires [Popper.js](https://popper-1.14.4.js.org/))
